...
class Bill{
    ...
    // getBillInfo METHOD
    public string getBillInfo(){ // Returns string contains all information in the bill including the payments. See the main() method and sample output to see what information is returned and then printed.
    ...
    List<Payment> PaymentList = new List<Payment>(); // List Object contains the details regarding Bill Info, Amount, Amount Paid, etc...
